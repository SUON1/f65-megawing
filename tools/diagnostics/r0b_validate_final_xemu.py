...
evidence = {
    ...
    "identity": {"contract_sha256": result[8:40].hex(), "llvm_mos": "v23.1.0", "abi_base_page": result[44], "lto_zp": result[45], "harness_revision": result[7], "d81_sha256": hashlib.sha256((artifacts / "R0BFINAL.D81").read_bytes()).hexdigest(), "prg_sha256": hashlib.sha256((artifacts / "F65-R0B-FINAL.prg").read_bytes()).hexdigest()},

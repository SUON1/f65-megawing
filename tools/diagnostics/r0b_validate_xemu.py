...
if result[:6] != b"R0B1\x01\x01" or result[9] != 1:
    raise SystemExit(f"R0B-BLD-001 FAIL: result block {result.hex()}")
if "R0-B TEST RUN COMPLETE" not in screen or "R0B-BLD-001 PASS" not in screen or "R0B-FCM-REG-001 PASS" not in screen:

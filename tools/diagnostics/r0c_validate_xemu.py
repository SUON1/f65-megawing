...
evidence = {"identity":"r0c-0.1.0-proof","class":"XEMU","result":"PASS","tests":["R0C-ID-001","R0C-PKG-001","R0C-CAP-001","R0C-RES-001","R0C-STG-001","R0C-ATTIC-001","R0C-NODISK-001","R0C-MEDIA-BOOT-001 media-only D81 AUTOBOOT loads fixture from device 9","R0C-MEDIA-XEMU-001 fixture menu"],"resultBlockSha256":hashlib.sha256(block).hexdigest(),"mediaFixture":{"d81MountedAt":[9],"autobootLoadsFrom":9,"transactionExecution":"NOT_CLAIMED; physical fault matrix remains required"},"deferred":["R0C-ROM-001 authoritative post-ROM storage restoration","R0C-SAVE-001 physical media transaction evidence","R0C-MEDIA-001 physical fault matrix","R0C-ATTIC-001 physical MEGA65 ABI measurement"]}

...
required = ["R0-C TEST RUN COMPLETE", "R0C-ID-001", "R0C-PKG-001", "R0C-CAP-001", "R0C-RES-001", "R0C-STG-001", "R0C-NODISK-001"]
...
evidence = {"identity":"r0c-0.1.0-proof","class":"XEMU","result":"PASS","tests":["R0C-ID-001","R0C-PKG-001","R0C-CAP-001","R0C-RES-001","R0C-STG-001","R0C-NODISK-001"],"resultBlockSha256":hashlib.sha256(block).hexdigest(),"deferred":["R0C-ROM-001 authoritative post-ROM storage restoration","R0C-SAVE-001 DEC-012 physical medium"]}

 ...
 *) echo "usage: $0 {bootstrap|generate|host-test|build|xemu|fcm-safe-build|fcm-safe-xemu|fcm-visible-build|fcm-visible-xemu|d031-safe-build|d031-safe-xemu|evidence|verify|clean}" >&2; exit 64 ;;
esac

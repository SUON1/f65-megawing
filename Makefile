...
r0d-clean: ; $(R0D) clean
r0e-bootstrap: ; $(R0E) bootstrap
r0e-generate: ; $(R0E) generate
r0e-host-test: ; $(R0E) host-test
r0e-build: ; $(R0E) build
r0e-verify: ; $(R0E) verify
r0e-clean: ; $(R0E) clean

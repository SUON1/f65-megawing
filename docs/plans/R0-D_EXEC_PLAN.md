...
Status: **R0-D CLOSED — owner accepted the admitted proof on 2026-08-31.**
`F65R0D3.D81` is `TEST_ELIGIBLE` for the bounded R0-D proof only.
...
| D4 | Target diagnostic observability and map/symbol/listing review | Complete — host/build and physical evidence |
...
| D6 | Four-stage evidence, handoff, and local commits | Complete — host, two-clean-boot Xemu, SD hash, physical chooser, calibration screen, publication, and owner acceptance recorded |
...
rename. Its final release record is
`docs/evidence/r0d/R0D-D81-D3-PHYSICAL-RELEASE.md`: host structural/content,
two-clean-boot Xemu, SD-copy hash, and physical chooser/calibration evidence
all PASS. This closure neither selects a production timing limit nor authorizes
R0-E/R0-F implementation.

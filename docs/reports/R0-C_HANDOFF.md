...
- Corrected D81 SHA-256: `e0d4600994cd7eb69870ea935974db0175868017e115222521965c7fc70d113`
...
- `F65-R0C-MEDIA.D81` SHA-256: `e0d4600994cd7eb69870ea935974db0175868017e115222521965c7fc70d113`
...
## Device-9 fixture repair reissue (2026-08-26)

The last physical attempt exposed two fixture defects, not a disk-9 setup error: blank media produced DOS 62 because initialization probed a file that did not yet exist; the old compact selector read/error path could fall into `?UNDEFINED STATEMENT ERROR IN 5110`. The fixture now accepts a blank sacrificial device-9 medium, creates its generation/selector files directly, and uses separate selector statements with controlled error return. Device 8 remains untouched.

`make r0c-build` reports static target validation PASS and the corrected device-9 fixture validator PASS. The replacement D81 is:
`build/r0c/artifacts/F65-R0C-MEDIA.D81`
SHA-256:
`e0d4600994cd7eb69870ea935974db0175868017e115222521965c7fc70d113`

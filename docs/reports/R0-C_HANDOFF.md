...
- `artifacts/F65-R0C-PROOF.prg` and `artifacts/R0CMEDIA.D81`.
...
- D81 SHA-256: `70232dbdb9cc044611f306a256e046ff6c6fbd5fc98500673276f79c44352aef`
...
- `R0CMEDIA.D81` SHA-256: `70232dbdb9cc044611f306a256e046ff6c6fbd5fc98500673276f79c44352aef`
...
The earlier combined D81 failed to mount in the physical image browser even
though the separate proof D81 mounted correctly. `R0CMEDIA.D81` is therefore
now a media-only fixture containing exactly `AUTOBOOT` and `R0C-MEDIA`, with no
proof PRG or package. Its `AUTOBOOT` explicitly loads `R0C-MEDIA` from device 9;
there is no device-8 fallback. The proof artifact remains separate and retains
its own explicit `R0C-FINAL`, device-9 entry. Xemu mounts the media-only D81 at
device 9 only and reaches the fixture menu; physical writes/faults remain
awaiting evidence.

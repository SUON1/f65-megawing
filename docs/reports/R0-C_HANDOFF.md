...
- `artifacts/F65-R0C-PROOF.prg` and `artifacts/ROCFINAL.D81`.
...
- D81 SHA-256: `8e306dddc31e38fe0e496e5fca67abafbc84ed6f4f827124dfff72e24fcc382b`
...
- `ROCFINAL.D81` SHA-256: `8e306dddc31e38fe0e496e5fca67abafbc84ed6f4f827124dfff72e24fcc382b`
...
The delivered `R0CMEDIA.D81` was rejected by the physical Freezer with
`ERROR CODE FF`. The replacement restores the already observed mountable
carrier shape as `ROCFINAL.D81`; this is an artifact filename only, never a
closure label. It contains the proof and device-9 fixture. `AUTOBOOT` explicitly
loads `R0C-FINAL` from device 9, while the fixture is explicitly loaded with
`LOAD "R0C-MEDIA",9,1`. There is no device-8 fallback. Xemu mounts the carrier
at device 9 only and reaches the fixture menu; physical writes/faults remain
awaiting evidence.
...
host/Xemu validation, guide, evidence, and the media-only fixture commit,
